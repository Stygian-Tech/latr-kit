...
public struct LatrXRPCMethod: Hashable, Sendable {
    ...
    public static let listTags = Self("link.latr.bookmarks.listTags", .query)
    ...
    public static let setBookmarkTags = Self("link.latr.bookmarks.setTags", .procedure)
    public static let renameBookmarkTag = Self("link.latr.bookmarks.renameTag", .procedure)
    public static let deleteBookmarkTag = Self("link.latr.bookmarks.deleteTag", .procedure)
    ...
    public static let all: [Self] = [.listBookmarks, .listTags, .getBookmark, .saveBookmark, .syncBookmarkMetadata, .setBookmarkState, .setBookmarkTags, .renameBookmarkTag, .deleteBookmarkTag, .deleteBookmark, .migrateBookmarks, .listItems, .getItem, .saveURL, .saveSubject, .setState, .deleteItem, .migrateLegacy, .getOpenGraph, .resolveURL, .authProbe, .listClients, .createClient, .deleteClient, .listKeys, .createKey, .revokeKey, .getUsage]
